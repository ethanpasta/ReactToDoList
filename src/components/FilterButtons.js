...
const FilterButtons = ({ dispatch }) => {
    return (
        <React.Fragment>
            ...
            <button className="filterButtons filterButtonOne" onClick={() => dispatch({ type: 'checkAll' })}>
            ...
            <button className="filterButtons filterButtonTwo" onClick={() => dispatch({ type: 'removeCompleted' })}>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 700 700">
